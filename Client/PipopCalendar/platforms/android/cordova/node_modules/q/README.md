...
```
Error: boo!
    at explode (/path/to/routes.js:3:11)
    at _fulfilled (/path/to/routes.js:q:54)
...
Error: boo!
    at explode (/path/to/routes.js:3:11)
From previous event:
    at theDepthsOfMyProgram (/path/to/routes.js:2:16)
    at Object.<anonymous> (/path/to/routes.js:7:1)
```
